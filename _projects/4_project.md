...
description: CLI tools with ASCII art for text visualization.
...
This paper explains some techniques and advantages: {% cite cmu_hash_visualization %}

You can find it on GitHub: [dinhphu28/randomart](https://github.com/dinhphu28/randomart)
